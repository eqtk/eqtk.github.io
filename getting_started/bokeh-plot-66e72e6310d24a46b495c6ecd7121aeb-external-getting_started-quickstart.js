(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("252e1376-6089-430d-b70c-5483b979e38b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '252e1376-6089-430d-b70c-5483b979e38b' but no matching script tag was found.")
        }
