(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("c4896a3d-4174-4696-839a-bfc36be312af");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c4896a3d-4174-4696-839a-bfc36be312af' but no matching script tag was found.")
        }
