(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("67783658-9a12-429d-b45f-6d57e91d432e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '67783658-9a12-429d-b45f-6d57e91d432e' but no matching script tag was found.")
        }
