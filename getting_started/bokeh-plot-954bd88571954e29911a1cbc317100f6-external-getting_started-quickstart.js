(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("cb707aa3-3d9d-47b5-a623-d527880b0617");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cb707aa3-3d9d-47b5-a623-d527880b0617' but no matching script tag was found.")
        }
