(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("2d315468-578f-4151-b3d1-88b766b8c9a9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '2d315468-578f-4151-b3d1-88b766b8c9a9' but no matching script tag was found.")
        }
