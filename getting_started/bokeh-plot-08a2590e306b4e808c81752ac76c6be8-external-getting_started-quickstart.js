(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("114fe2ea-191a-4407-a730-ec04d269a1cf");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '114fe2ea-191a-4407-a730-ec04d269a1cf' but no matching script tag was found.")
        }
