(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("ce3b45de-397c-42db-8ba7-bb0304875ed4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ce3b45de-397c-42db-8ba7-bb0304875ed4' but no matching script tag was found.")
        }
