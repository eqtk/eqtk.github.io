(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("9020610d-e7b4-4c50-92b2-e6fbddf64a1b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '9020610d-e7b4-4c50-92b2-e6fbddf64a1b' but no matching script tag was found.")
        }
