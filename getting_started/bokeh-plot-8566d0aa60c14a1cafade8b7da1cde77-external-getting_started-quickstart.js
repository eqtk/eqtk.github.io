(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("5d87a2bc-43a8-4040-a3ac-8fd3e30492ca");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '5d87a2bc-43a8-4040-a3ac-8fd3e30492ca' but no matching script tag was found.")
        }
