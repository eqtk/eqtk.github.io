(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("fdf22746-3b79-4333-9cff-d6b8269f7396");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fdf22746-3b79-4333-9cff-d6b8269f7396' but no matching script tag was found.")
        }
