(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("b1037d55-f144-4efa-be2d-663eb2c62dab");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b1037d55-f144-4efa-be2d-663eb2c62dab' but no matching script tag was found.")
        }
