(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("d87f6b66-2b9e-4a54-9370-b9d4df51a653");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd87f6b66-2b9e-4a54-9370-b9d4df51a653' but no matching script tag was found.")
        }
