(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("39232d3b-1817-4991-b5ff-e99f801ee851");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '39232d3b-1817-4991-b5ff-e99f801ee851' but no matching script tag was found.")
        }
