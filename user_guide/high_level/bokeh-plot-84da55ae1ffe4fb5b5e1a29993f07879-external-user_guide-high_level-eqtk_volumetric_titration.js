(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("10a45581-6e4e-4a95-ab7b-ea4025371b88");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '10a45581-6e4e-4a95-ab7b-ea4025371b88' but no matching script tag was found.")
        }
