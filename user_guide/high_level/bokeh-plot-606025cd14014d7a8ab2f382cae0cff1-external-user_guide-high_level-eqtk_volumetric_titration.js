(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("77b19876-7879-4db1-8c1c-d37929e7b98f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '77b19876-7879-4db1-8c1c-d37929e7b98f' but no matching script tag was found.")
        }
