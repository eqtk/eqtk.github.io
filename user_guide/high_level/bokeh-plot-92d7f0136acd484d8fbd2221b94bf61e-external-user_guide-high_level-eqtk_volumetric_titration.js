(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("d2956744-de71-4d2d-8dac-a5cd9c83d780");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd2956744-de71-4d2d-8dac-a5cd9c83d780' but no matching script tag was found.")
        }
