(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("8e6d8ca3-2285-417d-bc98-b491e3540943");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '8e6d8ca3-2285-417d-bc98-b491e3540943' but no matching script tag was found.")
        }
