(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("d0cd96d2-de0f-4dd2-accf-a919b33f1623");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd0cd96d2-de0f-4dd2-accf-a919b33f1623' but no matching script tag was found.")
        }
