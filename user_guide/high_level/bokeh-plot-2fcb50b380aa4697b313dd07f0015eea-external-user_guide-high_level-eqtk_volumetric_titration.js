(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("27a7fd27-371f-47cc-841d-df87226573b5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '27a7fd27-371f-47cc-841d-df87226573b5' but no matching script tag was found.")
        }
